const {
    AlignmentType, Document, HeadingLevel, Packer, Paragraph, TabStopPosition, TabStopType, TextRun
  } = require("docx");
...
function personalInformation(address, phone, email, linkedIn, github, portfolio) {
    return new Paragraph({
